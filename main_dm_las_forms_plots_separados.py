...
np.random.seed(555)  # semente fixada
...
def run_experiment(experiment_id):
    ...
    #fig = plt.figure(1) #novo
    #plt.subplot(221) #novo
    ...
    plt.savefig(os.path.join(output_folder, 'saida0_h'+str(pso.horizon[0])+','+str(pso.horizon[1])+'.pdf'))
    #plt.show() #novo
    plt.close(fig)
    ...
    plt.savefig(os.path.join(output_folder, 'saida1_h'+str(pso.horizon[0])+','+str(pso.horizon[1])+'.pdf'))
    #plt.show() #novo
    plt.close(fig)
    ...
    plt.savefig(os.path.join(output_folder, 'saida2_h'+str(pso.horizon[0])+','+str(pso.horizon[1])+'.pdf'))
    #plt.show() #novo
    plt.close(fig)
    ...
    plt.savefig(os.path.join(output_folder, 'saida3_h'+str(pso.horizon[0])+','+str(pso.horizon[1])+'.pdf'))
    #plt.show() #novo
    plt.close(fig)
    ...
    plt.savefig(os.path.join(output_folder, 'saida4_h'+str(pso.horizon[0])+','+str(pso.horizon[1])+'.pdf'))
    #plt.show() #novo
    plt.close(fig)
